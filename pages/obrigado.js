    ...
    <div className="bg-black text-white font-sans text-center">
      ...
      <main>
        ...
        <section className="py-20 px-6">
          ...
          <Link href="https://chat.whatsapp.com/C3qRZDCkrLZ9r2ECwmElJs" legacyBehavior>
        ...
        <section className="py-12 px-6">
          ...
          <p className="mb-6">Conheça a <Link href="/mentoria" legacyBehavior><a className="text-yellow-400 underline">Mentoria Algoritmo da Liberdade</a></Link> e tenha acompanhamento pessoal para aplicar seu propósito na prática.</p>
          <Link href="/mentoria" legacyBehavior>
